  ...
  const chart = new Chart(ctx, {
    ...
    options: {
        ...
        scales: {
            ...
            yAxes: [{ ticks: { beginAtZero: true, max: 10 } }] //исправил msx на 10 (максимально возможное кол-во соединений), иначе график не отображается, т.к. фактическая линия идет выше 0
        }
    }
  });
